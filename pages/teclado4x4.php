<?php
	...
	echo addBoxBeg('Teclados de matriz, interfaz con microcontroladores');
?>
...
<p><a href="/downloads/keypad.zip" data-no-instant>Descargar circuito impreso editable en Proteus</a></p>
