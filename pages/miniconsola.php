<?php
	...
	$tituloPagina = 'Mini consola de juegos con matriz de LEDs (8x8)';
	echo addBoxBeg('Mini consola de juegos con matriz de LEDs de 8x8');
?>
...
<p><a href="/downloads/miniconsola.zip" data-no-instant>Descargar esquemático, impreso y programación</a></p>
