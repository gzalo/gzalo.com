<?php
	...
	$tituloPagina = 'Simple tile engine using HTML5 and Canvas';
	$lang = 'en';
echo addBoxBeg('Tile engine using HTML5 and Canvas');
?>
...
<p><a href="/downloads/te.zip" data-no-instant>Download code</a> (License: Public domain, except for the tileset which is a <a href="http://www.planetminecraft.com/member/johnsmith27/texture_packs/server/">Minecraft texture pack, by JohnSmith27</a>) </p>
