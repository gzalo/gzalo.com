...
function calcularFps(){
	...
	ctx_txt.fillText(frames + ' FPS - ' + particulas.length + ' nodes',5,20);
	ctx_txt.font="15px Trebuchet MS";
	ctx_txt.fillText('Left mouse button: drag node',5,40);
	ctx_txt.fillText('Right mouse button: add node',5,60);
	ctx_txt.fillText('A: show/hide circles',5,80);
	ctx_txt.fillText('Q: show/hide radii',5,100);
	ctx_txt.fillText('W/S: increase/decrease measurement variance',5,120);
	ctx_txt.fillText('R: reset',5,140);
	frames = 0;
}
