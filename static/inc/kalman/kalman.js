...
function calcularFps(){
	fpsElemento.innerHTML = (frames/2) + ' FPS<br/>Position (real): ' + Math.round(posRealX) + ' ' + Math.round(posRealY) + '<br/>Position (estimated): ' + Math.round(x._data[0]) + ' ' + Math.round(x._data[1]);
	frames = 0;
}
